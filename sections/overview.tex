...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        \textbf{identified separately} from, and are capable of existing 
        independently of, the utilitarian aspects of the article.'' \S\ 101.  
        No protection if form and function are inextricable. \emph{Brandir}.
        \item \textbf{Government works}: generally not protected.
        ...
        \begin{enumerate}
            ...
            \item Architectural. Applies to the overall design, not specific 
            features.
            \item Musical works and sound recordings. Musical works (sheet 
            music, lyrics, arrangements): fully protected. Sound recordings: 
            no traditional performance rights (although they now have
            digital performance rights). For radio broadcasts, the owner of the 
